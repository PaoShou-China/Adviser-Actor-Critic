...
from torch.nn.functional import relu, selu, silu, tanh
...
class Network(NetworkBase):
    def __init__(self, layer_num, input_dim, output_dim, hidden_dim, activation_function='relu',
                 last_activation=None):
        super(Network, self).__init__()
        exec(f"self.activation = {activation_function}")
        exec(f"self.last_activation = {last_activation}")
